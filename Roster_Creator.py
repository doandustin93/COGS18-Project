# Both the lists of characters and their archetypes as well as the importation of the Smash_Classes module are required in order for the functions and methods to properly work. 
...
# To obtain and print the character's information based on their respective character-archetype.
def charinfo(char):
